    ...
    <div className={styles.rightpanel}>
      ...
      <div className={styles.rightpanel__info}>
        ...
        <div className={styles.rightpanel__infoSection}>
          ...
          <div className={styles.rightpanel__infoSection__text}>
